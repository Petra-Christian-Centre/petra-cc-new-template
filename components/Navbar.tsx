        ...
        <div className="flex justify-between items-center h-16">
          ...
          <div className="hidden lg:block">
            <button
              ...
              className="inline-flex items-center gap-2 py-3 px-6 rounded-lg bg-black text-white hover:bg-gray-800 focus:outline-none"
            >
              {!isMenuOpen ? (
                <div className="w-4 h-5 flex flex-col justify-between items-end">
