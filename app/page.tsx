    ...
    <div className="min-h-screen bg-gray-50">      
      <div className="relative h-screen flex items-center">        
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          ...
          <div className="absolute right-4 top-1/2 grid grid-cols-2 -translate-y-1/2 space-y-4">            

            <div className="bg-[#2F4F4F] text-white p-6 rounded-2xl w-64">
              <Image
                src="/images/pastor-ayo.jpg"
                alt="Pastor Ayo"
                width={50}
                height={50}
            ...
            <div>
              <div className="bg-[#4D4D4D] text-white p-6 rounded-2xl w-64">
